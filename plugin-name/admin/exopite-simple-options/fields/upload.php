    ...
    class Exopite_Simple_Options_Framework_Field_upload extends Exopite_Simple_Options_Framework_Fields {
        ...
        public function output(){
            ...
            <script type="text/template" id="qq-template-manual-trigger">
                <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="<?php esc_html_e( 'Drop files here', 'exopite-sof' ); ?>">
                    ...
                    <ul class="qq-upload-list-selector qq-upload-list" aria-live="polite" aria-relevant="additions removals">
                        <li>
                            ...
                            <button type="button" class="qq-btn qq-upload-cancel-selector qq-upload-cancel"><?php esc_html_e( 'Cancel', 'exopite-sof' ); ?></button>
                            <button type="button" class="qq-btn qq-upload-retry-selector qq-upload-retry"><?php esc_html_e( 'Retry', 'exopite-sof' ); ?></button>
                            <button type="button" class="qq-btn qq-upload-delete-selector qq-upload-delete"><?php esc_html_e( 'Delete', 'exopite-sof' ); ?></button>
                    ...
                    <dialog class="qq-alert-dialog-selector">
                        ...
                        <div class="qq-dialog-buttons">
                            <button type="button" class="qq-cancel-button-selector"><?php esc_html_e( 'Close', 'exopite-sof' ); ?></button>
                        </div>
                    </dialog>
                    ...
                    <dialog class="qq-confirm-dialog-selector">
                        <div class="qq-dialog-message-selector"></div>
                        <div class="qq-dialog-buttons">
                            <button type="button" class="qq-cancel-button-selector"><?php esc_html_e( 'No', 'exopite-sof' ); ?></button>
                            <button type="button" class="qq-ok-button-selector"><?php esc_html_e( 'Yes', 'exopite-sof' ); ?></button>
                        </div>
                    </dialog>
                    ...
                    <dialog class="qq-prompt-dialog-selector">
                        ...
                        <input type="text">
                        <div class="qq-dialog-buttons">
                            <button type="button" class="qq-cancel-button-selector"><?php esc_html_e( 'Cancel', 'exopite-sof' ); ?></button>
                            <button type="button" class="qq-ok-button-selector"><?php esc_html_e( 'Ok', 'exopite-sof' ); ?></button>
                        </div>
                    </dialog>
                </div>
            </script>
